...
public class CreateUserHandlerTests
{
    ...
    {
        // Arrange
        var command = new CreateUserCommand(); // invalid empty command
    ...
    [Fact(DisplayName = "Given user creation request When handling Then password is hashed before saving")]
